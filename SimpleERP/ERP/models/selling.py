...
class Salesinvoice(models.Model):
    ...
    bill_payment_type=models.FloatField(default=0)
...
class ServiceBilling_Items(models.Model):
    service_item_rate=models.FloatField(default=0)
    sales_invoice=models.ForeignKey(
    Salesinvoice, on_delete=models.CASCADE,default=None, blank=False, null=False)
    service_item_for=models.ForeignKey(
        Item, on_delete=models.CASCADE, blank=False, null=False,default=None,related_name="service_item_for_service_billing")
    service_item=models.ForeignKey(
        Item, on_delete=models.CASCADE, blank=False, null=False,default=None,related_name="service_item_service_billing")
    warehouse=models.ForeignKey(
        WareHouse, on_delete=models.CASCADE, blank=True, null=True,default=None)
    service_item_qty=models.FloatField(default=0)
    service_item_rate=models.FloatField(default=0)
    service_item_amount=models.FloatField(default=0)
    deleted = models.BooleanField(default=False)
    batchno=models.CharField(max_length=100,default=None,blank=True, null=True)
    company=models.ForeignKey(Company,on_delete=models.CASCADE,default=1)
