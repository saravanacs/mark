...
class ServiceBilling_ItemsSerializer(serializers.ModelSerializer):
    class Meta(object):
        """docstring for Meta"""
        model = ServiceBilling_Items
        fields = "__all__"
...
class LeadcsSerializer(serializers.ModelSerializer):
    class Meta(object):
        model = Leadcs
        fields = "__all__"
